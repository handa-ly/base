...
/**
    *@ClassName: BatchUpdateByPrimaryKeyProvider
    *@Description: TODO
    *@Author: handa
    *@Date: 2020/5/25 12:00
    */
    
    
public class BatchUpdateByPrimaryKeyProvider extends ExampleProvider {
    public BatchUpdateByPrimaryKeyProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
